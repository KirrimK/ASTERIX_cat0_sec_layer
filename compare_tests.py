...
if __name__ == '__main__':
    times_sgn_ed25519, times_vrf_ed25519 = generic_test.test_sign_verify_times(test_ed25519.keypair_generator, test_ed25519.sign_message, test_ed25519.verify_message, 10000, 48)
